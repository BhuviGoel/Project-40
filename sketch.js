...
var fruits;
var fruitGroup;
var fruit1_img, fruit2_img, fruit3_img, fruit4_img,gameover, fruit5_img;
var player_img;
var playerScore=0;
...
function preload(){
  ...
  gamover=loadImage("gameOver.png")
...
function draw() {
  ...
  //  text("Player1: "+player1.score,100,100);
  //  text("Player2: "+player2.score,100,200);
}